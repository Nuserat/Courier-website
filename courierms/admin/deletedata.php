...
<table style="width: 100%;">
	...
	<!--	<li><a href=".php">Price Control</a></li>  -->
		...
		<li><a href=".php">Delivery Details</a></li>
...
<table width='70%' border="1px solid" style="margin-left: 330px; margin-right:auto; margin-top:30px; font-weight:bold;border-spacing: 5px 5px;">
