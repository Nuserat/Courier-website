...
<table width='70%' border="1px solid" style="margin-left:350px; margin-right:auto; margin-top:10px; font-weight:bold;border-collapse: collapse;">
    ...
    <?php
        ...
        if(mysqli_num_rows($run)<1){
            ...
            <tr align="center">
                ...
                <td><a href="usersdeleted.php?emm=<?php echo $data['email']; ?>">Delete</a></td>
            </tr>
            <?php
            }
        }
