...
<table style="width: 100%;">
		<tr>
			<td id="td1" style="padding: 10px; font-size: 48px;">CARGO-DASH COURIER SERVICE</td>
		</tr>
	</table>
	<ul>
...
<table width='70%' border="1px solid" style="margin-left:350px; margin-right:auto; margin-top:20px; font-weight:bold;border-spacing: 5px 5px;">
