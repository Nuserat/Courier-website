    ...
    <form action="courierMenu.php" method="POST" enctype="multipart/form-data">
        <div style="overflow-x:auto;">
            <table border="0px solid" style="margin: auto; font-weight:bold;border-spacing: 10px 15px;">
                <th colspan="4" style="text-align: center;background-color:#D3C8BD;color:#2C2A28; width: 180px; height: 50px;">Fill The Details Of Sender & Receiver</th>
                <tr>
                    <td colspan="4" style="text-align: center; text-color:#E2D8CE">
                        <hr>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>Date:</td>
                    <td colspan="2"><input type="date" name="date" value="<?php echo date('Y-m-d'); ?>" readonly /></td>

                    <td>Items Image:</td>
                    <td><input type="file" name="simg" ></td>
                </tr>
                <tr>
						<td style="	text-align: center;">Select deliver type:</td>
						<td style="	text-align: center;">
							<select name="rooms" required>
								<option value="">Select</option>
								<option value="Normal Delivery">Normal Delivery</option>
								<option value="VIP Delivery">VIP Delivery</option>
								<option value="Urgent Delivery">Urgent Delivery</option>
							</select>
						</td>
					</tr>
                <tr>
                    <td colspan="4" align="center"><input type="submit" name="submit" value="Place Order" style="background-color: orange; margin-top:10ox; border-radius: 15px; width: 140px; height: 40px;cursor:pointer;"></td>
                </tr>
            </table>
        </div>
    </form>
...
if (isset($_POST['submit'])) { //if we'll not give this,it'will submit from with zero values.
    ...
    $qry = "INSERT INTO `courier` (`sname`, `rname`, `semail`, `remail`, `sphone`, `rphone`, `saddress`, `raddress`, `weight`, `billno`, `image`,`date`,`dt`,`price`,`u_id`) VALUES ('$sname', '$rname', '$semail', '$remail', '$sphone', '$rphone', '$sadd', '$radd', '$wgt', '$billn', '$imagenam', '$newDate','$dt','$price','$uid')";
    $run = mysqli_query($dbcon, $qry);
    $sqlt = "INSERT INTO payment VALUES ('$sname', '$dt','$newDate', '$billn', '$price')";
    ...
    $sqlt = "INSERT INTO booking (billno, date) VALUES ('$billn', '$newDate');";
	mysqli_query($dbcon,$sqlt);
