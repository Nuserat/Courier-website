...
?>
        <script>
            ...
            window.open('index.php', '_self');
                    ...
                    ?>
        <script>
            window.open('home/profile.php', '_self');
        </script> <?php
...
<body>
    <h1 align='center' style="margin: 15px; color:seagreen;font-weight: bold;font-family:'Times New Roman', Times, serif">CARGO-DASH COURIER SERVICE</h1>
    <hr />
